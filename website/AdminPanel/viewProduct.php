                        ...
                        <div class="bg-secondary rounded  h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    <tbody>
                                       <?php 
                                       $query = $pdo->query("select products.id,products.name as pName ,products.price,products.location,products.description,products.image, categories.name as cName from products inner join categories on products.c_id = categories.id");
