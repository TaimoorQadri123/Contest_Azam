                    ...
                    <!-- <div class="col-sm-12 col-xl-6"> -->
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method ="post"  enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label text-white" >Category Description</label>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label text-white" >Category Image</label>
