                    ...
                    <!-- <div class="col-sm-12 col-xl-6"> -->
                        <div class="bg-secondary rounded rounded h-100 p-4">
                            ...
                            <form method ="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label"> Products Location </label>
                                         <input value="<?php echo $productLocation?>" class="form-control" name="pLocation"type="text">
                                        <small class="text-danger"><?php echo $productLocationErr?></small>
