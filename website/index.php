...
.destination-img img {
    ...
    object-fit: cover; }
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption">
                                <div class="p-3" style="max-width: 900px;">
                                   ...
                                   <p class="mb-5 fs-5">Discover the beauty of the world through our lens — breathtaking views, vibrant cultures, and unforgettable travel memories captured in every frame.</p>

                                    <div class="d-flex align-items-center justify-content-center">
                                        <a class="btn-hover-bg btn btn-primary rounded-pill text-white py-3 px-5" href="products.php">Discover Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- <div class="container-fluid search-bar position-relative" style="top: -500%; transform: translateY(-50%);">
            <div class="container">
                    ...
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                            <div class="service-content text-end">
                                ...
                                <p class="mb-0">Explore the most beautiful destinations across the globe with our well-planned international tours — from Europe’s charm to Asia’s wonders, we take you there in style and comfort.</p>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                            <div class="service-content text-end">
                                ...
                                <p class="mb-0">We partner with top hotels to provide you with luxury and budget-friendly accommodation options, ensuring a relaxing stay wherever you go.</p>
                            </div>
                            <div class="service-icon p-4">
                    ...
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                            <div class="service-content text-end">
                                ...
                                <p class="mb-0">Our expert travel guides help you experience each destination like a local — with stories, culture, and hidden gems you won't find in brochures.</p>
                            </div>
                            <div class="service-icon p-4">
                    ...
                    <div class="col-12">
                        <div class="service-content-inner d-flex align-items-center bg-white border border-primary rounded p-4 pe-0">
                            <div class="service-content text-end">
                                ...
                                <p class="mb-0">From destination weddings to corporate retreats, we handle every detail of your event to create an unforgettable experience — wherever in the world it may be.</p>
                            </div>
                            <div class="service-icon p-4">
...
<!-- Services End -->
        ...
        <div class="container-fluid ExploreTour py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    ...
                    <p class="mb-0">"Explore our categories: Accommodation, Transport, Trip Catalog, Packages, and Reviews."
                    </p>
                </div>
                ...
                <?php
                $query = $pdo->query("select * from categories limit 4 ");
                ...
                ?>
                                <div class="col-md-6 col-lg-4" >
                                    <div class="national-item" >
                                        <img  height="500px" src="AdminPanel/images/<?php echo $category['image']?>" class="img-fluid w-100 rounded" alt="Image">
                                        <div class="national-content">
                                            <div class="national-info">
                                                <h5 class="text-white text-uppercase mb-2"><?php echo $category['name']?></h5>
                                                <a href="product.php?cId=<?php echo $category['id']  ?>" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a>
                                            </div>
                                        </div>
                                        <div class="national-plus-icon">
                                            <a href="product.php?cId=<?php echo $category['id']  ?>" class="my-auto"><i class="fas fa-link fa-2x text-white"></i></a>
                                        </div>
                                    </div>
                                </div>                 
        ...
        <!-- Gallery Start -->
        <div class="container justify-content-center align-items-center gallery py-5 my-5">
            <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                <h5 class="section-title px-3">Our Gallery</h5>
                <h1 class="mb-4">Tourism & Traveling Gallery.</h1>
               <p class="mb-0">Explore stunning moments captured from our adventures around the world — from majestic mountains to serene beaches, each photo tells a story of unforgettable travel experiences and cultural discoveries.</p>
				...
				foreach ($allGallery as $Gallery){
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-2">
                                <div class="gallery-item h-100">
                                    <img height="500px" src="AdminPanel/images/<?php echo $Gallery['image']?>" class="img-fluid w-100 h-100 rounded" alt="Image">
                                    <div class="gallery-content">
                                        <div class="gallery-info">
                                            <h5 class="text-white text-uppercase mb-2"><?php echo $Gallery['name']?></h5>
                                            <!-- <a href="#" class="btn-hover text-white">View All Place <i class="fa fa-arrow-right ms-2"></i></a> -->
                                        </div>
                                    </div>
                                    <!-- <div class="gallery-plus-icon">
                                        <a href="img/gallery-1.jpg" data-lightbox="gallery" class="my-auto"><i class="fas fa-plus fa-2x text-white"></i></a>
                                    </div> -->
                                </div>
                            </div>
 ...
 <div class="container-fluid guide py-5">
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            ...
            <h1 class="mb-0">Meet Our Expert Guides</h1>
        </div>
        <div class="row g-4">
                ...
                <div class="guide-item">
                    ...
                    <div class="guide-title text-center rounded-bottom p-4">
                        <div class="guide-title-inner">
                            <h4 class="mt-3">Jhon Doe</h4>
                            <p class="mb-0">Senior Tour Guide - Europe</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="guide-item">
                    ...
                    <div class="guide-title text-center rounded-bottom p-4">
                        <div class="guide-title-inner">
                            <h4 class="mt-3">Jhon Doe</h4>
                            <p class="mb-0">Cultural Guide - Middle East</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="guide-item">
                    ...
                    <div class="guide-title text-center rounded-bottom p-4">
                        <div class="guide-title-inner">
                            ...
                            <p class="mb-0">Adventure Guide - Asia</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="guide-item">
                    ...
                    <div class="guide-title text-center rounded-bottom p-4">
                        <div class="guide-title-inner">
                            <h4 class="mt-3">Jhon Doe</h4>
                            <p class="mb-0">Wildlife Guide - Africa</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container-fluid blog py-5">
    <div class="container py-5">
        <div class="mx-auto text-center mb-5" style="max-width: 900px;">
            ...
            <p class="mb-0">Discover exciting travel stories, expert tips, and inspiring destinations from travelers around the globe.</p>
        </div>
        <div class="row g-4 justify-content-center">
                ...
                <div class="blog-item">
                    <div class="blog-img">
                        <div class="blog-img-inner">
                            <img class="img-fluid w-100 rounded-top" src="img/blog-1.jpg" alt="Beach Paradise">
                            <div class="blog-icon">
                                <a href="#" class="my-auto"><i class="fas fa-link fa-2x text-white"></i></a>
                            </div>
                        </div>
                        <div class="blog-info d-flex align-items-center border border-start-0 border-end-0">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>12 Aug 2025</small>
                            ...
                            <a href="#" class="btn-hover flex-fill text-center text-white py-2"><i class="fa fa-comments text-primary me-2"></i>900</a>
                        </div>
                    </div>
                    <div class="blog-content border border-top-0 rounded-bottom p-4">
                        <p class="mb-3">Posted By: Sara Khan</p>
                        <a href="#" class="h4">Top 5 Beach Destinations for Summer 2025</a>
                        <p class="my-3">Explore the most breathtaking beaches to relax and soak up the sun this summer season.</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <div class="blog-img">
                        <div class="blog-img-inner">
                            <img class="img-fluid w-100 rounded-top" src="img/blog-2.jpg" alt="Mountain Hiking">
                            <div class="blog-icon">
                                <a href="#" class="my-auto"><i class="fas fa-link fa-2x text-white"></i></a>
                            </div>
                        </div>
                        <div class="blog-info d-flex align-items-center border border-start-0 border-end-0">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>05 Sep 2025</small>
                            <a href="#" class="btn-hover flex-fill text-center text-white border-end py-2"><i class="fa fa-thumbs-up text-primary me-2"></i>3K</a>
                            <a href="#" class="btn-hover flex-fill text-center text-white py-2"><i class="fa fa-comments text-primary me-2"></i>1.2K</a>
                        </div>
                    </div>
                    <div class="blog-content border border-top-0 rounded-bottom p-4">
                        <p class="mb-3">Posted By: Ali Raza</p>
                        <a href="#" class="h4">Hiking Trails You Can't Miss in the Alps</a>
                        <p class="my-3">A guide to the best hiking spots in the Alps with tips for beginners and pros alike.</p>
                        <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <div class="blog-img">
                        <div class="blog-img-inner">
                            <img class="img-fluid w-100 rounded-top" src="img/blog-3.jpg" alt="City Lights">
                            <div class="blog-icon">
                                <a href="#" class="my-auto"><i class="fas fa-link fa-2x text-white"></i></a>
                            </div>
                        </div>
                        <div class="blog-info d-flex align-items-center border border-start-0 border-end-0">
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>22 Jul 2025</small>
                            <a href="#" class="btn-hover flex-fill text-center text-white border-end py-2"><i class="fa fa-thumbs-up text-primary me-2"></i>2.5K</a>
                            <a href="#" class="btn-hover flex-fill text-center text-white py-2"><i class="fa fa-comments text-primary me-2"></i>1.1K</a>
                        </div>
                    </div>
                    <div class="blog-content border border-top-0 rounded-bottom p-4">
                        <p class="mb-3">Posted By: Nadia Ali</p>
                        <a href="#" class="h4">Exploring the Nightlife of Tokyo</a>
                        <p class="my-3">Experience the vibrant nightlife of Tokyo with our guide to the best clubs, bars, and food spots.</p>
                        <a href="#" class="btn btn-primary rounded-pill py-2 px-4">Read More</a>
                    </div>
                </div>
            </div>
